      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl sm:text-3xl font-black font-heading tracking-tight">{t.todayMatches}</h2>
          </div>
          <Button
            onClick={refetch}
            disabled={loading}
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            ...
            {liveMatches.length > 0 && (
              <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold font-heading text-red-500 uppercase tracking-wider">
            ...
            {upcomingMatches.length > 0 && (
              <section className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold font-heading uppercase tracking-wider">
            ...
            {finishedMatches.length > 0 && (
              <section className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold font-heading text-muted-foreground uppercase tracking-wider">
            ...
            {/* CTA Section */}
            <section className="mt-12 p-6 sm:p-8 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
